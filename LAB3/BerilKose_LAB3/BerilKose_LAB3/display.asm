 ...
 */ 
 ...
 display: 
   ...
   mov r16, r5 ; fiziksel olarak pd0 pd1 ve pd3 digit olarak MCU ya baðlanmýþ. Bu yüzden otomatik olarak digit olarak bu portlarý alýyoruz.
   rcall digit 
